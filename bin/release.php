...
const SHOPWARE_VERSIONS  = '~6.2 || ~6.3';
...
switch ($release_env) {
	case RELEASE_GIT_ENV:
		exec('composer require trustpayments/sdk 2.1.2 -d /var/www/shopware.local');
		$composerJsonData['require']['trustpayments/sdk'] = '2.1.2';
		break;
	case RELEASE_SW_ENV:
		exec('composer require trustpayments/sdk 2.1.2 -d /var/www/shopware.local/custom/plugins/TrustPaymentsPayment');
		break;
}
