...
namespace TrustPaymentsPayment\Core\Api\OrderDeliveryState\Service;
...
use Shopware\Core\{
	...
	Framework\Uuid\Uuid};
use TrustPaymentsPayment\Core\Api\OrderDeliveryState\Handler\OrderDeliveryStateHandler;
use TrustPaymentsPayment\Core\Util\LocaleCodeProvider;

/**
 * Class OrderDeliveryStateService
 *
 * @package TrustPaymentsPayment\Core\Api\OrderDeliveryState\Service
 */
class OrderDeliveryStateService {
