...
class TransactionController extends AbstractController {
	 ...
	 * @Route(
	 *     "/api/_action/trustpayments/transaction/get-transaction-data/",
	 ...
	 *
	 * @Route(
	 *     "/api/_action/trustpayments/transaction/get-invoice-document/{salesChannelId}/{transactionId}",
	 ...
	 *
	 * @Route(
	 *     "/api/_action/trustpayments/transaction/get-packing-slip/{salesChannelId}/{transactionId}",
