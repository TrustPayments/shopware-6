...
class TransactionService {
	...
	): void
	{
		try {
            ...
            if ($chargeAttempt) {
                ...
                $dataParamValue['customerName']  = isset($transactionMetaData[TransactionPayload::TRUSTPAYMENTS_METADATA_CUSTOMER_NAME])
                    ? $transactionMetaData[TransactionPayload::TRUSTPAYMENTS_METADATA_CUSTOMER_NAME]
                    : '';
	...
	/**
	 * Get transaction entity by TrustPayments order transaction id
	 *
