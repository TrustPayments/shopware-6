...
namespace TrustPaymentsPayment\Core\Storefront\Account\Controller;
...
class AccountOrderController extends StorefrontController {
	 ...
	 * @Route(
	 *     "/trustpayments/account/order/download/invoice/document/{orderId}",
	 *     name="frontend.trustpayments.account.order.download.invoice.document",
	 *     methods={"GET"}
	 *     )
	 */
